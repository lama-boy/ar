...
import gui.panel.layout.BorderLayoutPanel;
	...
	public class SelectFSeat extends AppView implements ActionListener, ItemListener {
		...
		// 행, 열
		private JCheckBox[][] seats = new JCheckBox[10][2];
		...
		public SelectFSeat(TicketDTO ticket) {
			this.ticket = ticket;
			setInfotoLabel();
			setPerson();
			buildGUI();
