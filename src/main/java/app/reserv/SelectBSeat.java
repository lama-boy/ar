...
import gui.panel.layout.BorderLayoutPanel;
	...
	public class SelectBSeat extends AppView implements ActionListener, ItemListener {
		...
		// 행, 열
		private JCheckBox[][] seats = new JCheckBox[10][5];
		...
		public SelectBSeat(TicketDTO ticket) {
			this.ticket = ticket;
			setInfotoLabel();
			setPerson();
			buildGUI();
		...
		public void buildGUI() {
		    ...
		    for(int i=0;  i< 4; i++) {
			  ...
			  //CenterPanel 추가
			    ...
			    blPanel.newPanel(BorderLayout.CENTER).add(panel);
