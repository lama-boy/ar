...
public class WrapFrame extends JFrame implements MouseListener, MouseMotionListener, KeyListener {
	...
	public WrapFrame(int width, int height) {
		...
		wrapPanel.addMouseListener(this);
		wrapPanel.addMouseMotionListener(this);
		addKeyListener(this);
...
class WrapPanel extends JPanel {
	Color color = new Color(0, 0, 255, 108);
	
	public WrapPanel(int width, int height) {
